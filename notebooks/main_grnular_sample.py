...
parser.add_argument('--USE_CUDA_FLAG', type=int, default=0,
                    help='USE GPU if = 1')
...
parser.add_argument('--lr_glad', type=float, default=0.03, #0.01,
...
parser.add_argument('--lrDNN', type=float, default=0.03,
...
#    for k in abbrv_dict.keys():
    for k in ['K_train', 'K_valid', 'K_test', 'D', 'C',
                  'sparsity', 'DATA_TYPE', 'POINTS_PER_CLASS',
                  'SAMPLING_STATE', 'NOISE_PARAMS', 'DECAYS',
                  'NOISE_TYPE', 'SHARED_COOP_STATE', 'pcr_low_min',
                  'pcr_low_max', 'pcr_high_min', 'pcr_high_max',
                  'Kij_min', 'Kij_max', 'ratio_MR', 'connect_TF_prob']:
        v = dict1[k]
